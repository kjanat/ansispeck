...
- `createColors()` uses `for...in` loop over `SGR` map (1 `as Colors` cast)
- `SgrEntry` tuple type: `[open, close]` or `[open, close, reopen]`
- Minified: 1,407 B (+37 B vs hand-rolled baseline)
